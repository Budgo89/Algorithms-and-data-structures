...
namespace Algorithms_and_data_structures
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                X = 5, Expected = true, ExpectedException = null
            };
            ...
            {
                X = 10, Expected = false, ExpectedException = null
            };
            var testCase4 = new TestCase()
            {
                X = 4, Expected = true, ExpectedException = null
            };
            var testCase5 = new TestCase()
            {
                X = 6, Expected = true, ExpectedException = null
            };
            ...
            {
                X = 0, Expected = 0, ExpectedException = null,
            };
            var TestCaseFib2 = new TestCaseFib()
            {
                X = 15, Expected = 610, ExpectedException = null,
            };
            var TestCaseFib3 = new TestCaseFib()
            {
                X = 7, Expected = 13, ExpectedException = null,
            };
            var TestCaseFib4 = new TestCaseFib()
            {
                X = 10, Expected = 56, ExpectedException = null,
            };
